...
def make_report():
    if request.method == 'POST':
        ...
        for key, value in incident_report_data.items():
            if key == 'happened':
                print(value)
            elif key == 'arrived':
                print(value)
    ...
    #     #          reported_contact='someone444', comments='sss', weather=22, time='2:22PM', outside_service_responder='something')
        ...
        #          person_3_extra=incident_report_data['person_3_extra'], event_description=incident_report_data['event_description'])
